...
public enum SmsTemplateEnum {
    ...
    tpl_91293(91293, "【Forexroo】亲爱的#name#，您正在解绑银行卡，验证码是#code#。如非本人操作，请忽略本短信。"), // 短信模板91293
    tpl_91292(91292, "【Forexroo】亲爱的#name#，您的银行卡已绑定成功，详情请登录手机客户端查看。"), // 短信模板91292
    tpl_91291(91291, "【Forexroo】亲爱的#name#，您正在绑定银行卡，验证码是#code#。如非本人操作，请忽略本短信。"), // 短信模板91291
    ...
    tpl_91283(91283, "【Forexroo】您正在修改手机号，验证码是#code#。如非本人操作，请忽略本短信。"), // 短信模板91283
    ...
    private SmsTemplateEnum(int id, String template) {
        this.id = id;
