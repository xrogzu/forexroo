...
@GenerateByApiEngineSdk(time = "2017.06.16 02:57:35.218", version = "v1.0.7")
public class BrokerRequest_SignAgreements_Api implements Api {
    ...
    public Response execute(Request request) throws Exception {
        ...
        if (user.getBrokerRequestStatus() != BrokerRequestStatusEnum.not.getValue() && user.getBrokerRequestStatus() != BrokerRequestStatusEnum.auditing_fail.getValue()) {
            throw new ApiExecuteException(ErrorCodeEnum.already_broker_request);
        }
        ...
        map.put(USER.BROKER_REQUEST_TIME, System.currentTimeMillis());
