...
@Comment(value = "OSS - 创建STS授权TOKEN")
@GenerateByApiEngineSdk(time = "2017.06.02 03:44:05.656", version = "v0.0.11")
public class Oss_CreateStsToken_Api implements Api {
    ...
    public Response execute(Request request) throws Exception {
        ...
        try {
            ...
            throw new ApiExecuteException(ErrorCodeEnum.oss_createStsToken_exception, e);
        }
        return resp;
    }
